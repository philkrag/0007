...
bool Step_Recorded = false;
bool Rotating_Forward = true;
int Encoder_A_Terminal = 2; 
int Encoder_B_Terminal = 3;                                                           // ...
int Encoder_A_Value = 0;
int Encoder_B_Value = 0;
int Encoder_A_Value_Memory = 0;
int Encoder_B_Value_Memory = 0;
...
if(Encoder_A_Value_Memory!=Encoder_B_Value_Memory){
Step_Recorded = false;
}  
}
